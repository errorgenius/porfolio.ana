...
import TuFactureroImage from '../assets/projects/tufacturero.png'
import MacanudoImage from '../assets/projects/macanudo.png'
import EcuafirmaImage from '../assets/projects/ecuafirma.png'
...
export const PROJECTS = [
  {
    title: "Macanudo",
    description:
      "Panel de administración para restaurante argentino en Barcelona, con integracon de Agentes de inteligencia artificial",
    image: MacanudoImage,
    tags: [TAGS.REACT, TAGS.MONGO, TAGS.FASTAPI],
  },
  {
    title: "TuFacturero",
    description:
      "Sistema de Facturacion Electronica",
    image: TuFactureroImage,
    tags: [TAGS.SPRINGBOOT, TAGS.FLUTTER, TAGS.MATERIAL],
  },
  {
    title: "Ecuafirma",
    description:
      "Sistema de Firma Electrónica",
    image: EcuafirmaImage,
    tags: [TAGS.SPRINGBOOT, TAGS.FLUTTER, TAGS.MATERIAL, TAGS.REACT],
  },
  {
    title: "Alma System",
    description:
